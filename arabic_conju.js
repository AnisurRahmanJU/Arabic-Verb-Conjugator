...

{
  ...
  document.getElementById("result").innerText = " ";
      ...
      document.getElementById("result").innerText = " containing أ ي و week root or double letter. Use Paid Version for full access. Paymetn option will added soon. its an inovative project. our system can conjugate all arabic verb with 100% accuracy . contact:arabicdictionary.bd@gmail.com ";
  }
}
